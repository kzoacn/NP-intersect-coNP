...
| **P-matrix LCP** | ✓ | ✓ | ? | ? | ? | [MegPap91], [CPS92], [Rus07] |
| **Tropical Linear Programming** | ✓ | ✓ | ✓ | ? | ? | [AGG12], [ABGJ15] |
| **Max-Atom Problem** | ✓ | ✓ | ✓ | ? | ? | [BNRC08], [AM09] |
...
* **[AGG12]** Akian, M., Gaubert, S., & Guterman, A. (2012). Tropical polyhedra are equivalent to mean payoff games. International Journal of Algebra and Computation, 22(1).
* **[ABGJ15]** Allamigeon, X., Benchimol, P., Gaubert, S., & Joswig, M. (2015). Combinatorial simplex algorithms can solve mean payoff games. SIAM Journal on Optimization, 24(4), 2096-2117.
* **[AKS02]** Agrawal, M., Kayal, N., & Saxena, N. (2004). PRIMES is in P. Annals of mathematics, 781-793.
* **[AM09]** Atserias, A., & Maneva, E. N. (2009). Mean-payoff games and the max-atom problem. Manuscript.
...
* **[BNRC08]** Bezem, M., Nieuwenhuis, R., & Rodríguez-Carbonell, E. (2008). The max-atom problem and its relevance. In International Conference on Logic for Programming Artificial Intelligence and Reasoning.
...
* **[Cai04]** Cai, J. Y. (2004). A note on quadratic residuosity and UP. Information Processing Letters, 92(1), 29-30.
...
* **[CPS92]** Cottle, R. W., Pang, J. S., & Stone, R. E. (1992). The Linear Complementarity Problem. Academic Press.
...
* **[MegPap91]** Megiddo, N., & Papadimitriou, C. H. (1991). On total functions, existence theorems and computational complexity. Theoretical Computer Science, 81(2), 317-324.
...
* **[Rus07]** Rüst, L. Y. (2007). The P-Matrix Linear Complementarity Problem. Ph.D. thesis, ETH Zurich.
...
* **[Thi94]** Thiel, Christoph. "Under the assumption of the Generalized Riemann Hypothesis verifying the class number belongs to NP∩ co-NP." International Algorithmic Number Theory Symposium. Berlin, Heidelberg: Springer Heidelberg, 1994.
...
We thank Zhengyang Liu for valuable discussions covering TFNP, PPAD, UGC, and beyond. We also appreciate the helpful discussions with Anyu Wang, Kaijie Jiang, Youlong Ding, Chihao Zhang, Wenhan Huang, Yiding Feng and Paul Kirchner, alongside EI, 142857cs, Tylemon, QingzhiMao, and Fast Photon from the UOJ QQ Chat Group.
